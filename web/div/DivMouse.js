...
// Created 2016-03-05 by Henrik Bjorkman www.eit.se/hb


// subclass extends superclass
DivMouse.prototype = Object.create(DivBase.prototype);
DivMouse.prototype.constructor = DivMouse;
...
function DivMouse(parentWin)
{	
	this.parentWin=parentWin;
}

// Returns the html code needed to show the div.
DivMouse.prototype.defineDiv=function(divSize)
{
	console.log('defineDiv not implemented '+divSize.x+" "+divSize.y);
}


DivMouse.prototype.drawDiv=function()
{
	console.log('drawDiv not implemented');
}

DivMouse.prototype.click=function(mouseUpPos)
{
	console.log('click not implemented');
}


DivMouse.prototype.drag=function(mouseDownPos, mouseUpPos)
{
...
DivMouse.prototype.addEventListenersDiv=function(canvasName)
{
...
DivMouse.prototype.mouseDiff=function(m1, m2)
{
...
DivMouse.prototype.getRootDiv=function()
{
	/*
