...
{
	//console.log("hlibSplitString: "+str);
	...
	while(b<len)
	{
		...
		if (str[b]=='"')
		{
			...
			while((e<len) && ( str[e]!='"' ))
			{
				...
				if(ch=='\\')
				{
					// This was an escape char (used if original string contained quotes, linefeed or the escape char itself.
					...
					{
						ch=str[e];
						//console.log("hlibSplitString escaped char: "+ch);
						if (ch=='n')
						{
							tmpStr+='\n';						
						}
