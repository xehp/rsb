...
public:
	...
	enum
	{
		...
		specEnd=35,
		specHome=36,
		specRight=39, // should be 37?
		specUp=38,
		specLeft=37, // should be 39?
		specDown=40,
	...
	// These enums will hopefully match the keyboardMappings in PlayerConnectionThread.java or UserAccount.java
	enum
	{
		undefinedKey=0,
		actionKey=1,
