...
int pyramid3dInitGl()
{
	...
	// Get fragment source
	#ifdef __APPLE__
		const GLchar* fragmentShaderSource[] = { "\n uniform float fade; varying vec3 f_color; void main(void) { gl_FragColor = vec4(f_color.x, f_color.y, f_color.z, fade); }" }; // 1.0, 1.0, 1.0 for all white
	#elif defined USE_OPENGL_2_1
