...
TextBillboard::TextBillboard(WindowObject *windowObject, float width, float height):
...
void TextBillboard::readSelf(WordReader *wr)
{
...
#ifndef __EMSCRIPTEN__
void TextBillboard::writeSelf(WordWriter *ww)
{
...
void TextBillboard::setupInternalRenderingData()
{
...
void TextBillboard::setText(const char *str)
{
	assert(windowObject!=NULL);
