...
public class TickThread implements Runnable
{
	...
	public TickThread(D1GlobalConfig config, D1TickList db) 
	{
		this.db=db;
		this.config=config;
	...
	public void run() 
	{
		while(!done) 
		{
			...
			{
				// Far behind, skip sim_frame_time forward, this can happen when debugging, desiredFrameRateMs is set to low or system load is to big.
